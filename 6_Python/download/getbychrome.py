...
def main_proc():
    base_url = "http://www.yuetingba.cn/book/detail/3a012d27-cd3c-d1ed-f907-9eeba6531208/200"
    driver = get_diver()
    driver.get(base_url)
...
def single_proc(btn, driver):
    ...
    if len(aeles)>0:
        #aeles[2].click()
        driver.execute_script("arguments[0].click();", aeles[2])
        time.sleep(20)
    else:
